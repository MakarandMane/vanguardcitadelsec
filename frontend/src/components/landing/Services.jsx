...
export default function Services() {
  return (
    ...
    >
      <div aria-hidden className="absolute inset-0 bg-grid-dark opacity-20 [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_75%)]" />
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          >
            Full-spectrum{" "}
            <span className="text-cyan-400">information security</span> services.
          </h2>
          <p
        ...
        >
          {SERVICES.map((s, i) => (
            <article
              ...
              className="group card-dark rounded-xl p-6 sm:p-7 transition-all"
            >
              <div className="flex items-center justify-between">
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-md bg-cyan-400/10 border border-cyan-400/20 text-cyan-400 group-hover:bg-cyan-400/20 transition-colors">
                  <s.icon className="h-5 w-5" strokeWidth={2} />
                </span>
                <span className="font-heading text-xs tracking-widest font-semibold text-slate-600">
              ...
              <div className="mt-6 inline-flex items-center gap-1.5 text-xs font-semibold tracking-wider uppercase text-cyan-400">
