...
const fieldClass =
  "mt-1.5 w-full h-11 rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors";
const textareaClass =
  "mt-1.5 w-full min-h-[140px] rounded-md border border-slate-300 bg-white p-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors resize-y";
...
export default function Contact() {
  ...
  return (
    <section
      ...
      className="relative py-20 lg:py-28 bg-white border-t border-slate-200/70"
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          >
            ...
            <span className="text-cyan-600">security posture?</span>
          </h2>
          <p
          ...
          <div className="mt-10 space-y-4">
            <div
              ...
              className="flex items-start gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 hover:border-cyan-400 transition-colors"
            >
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-md bg-cyan-50 border border-cyan-100 text-cyan-600">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-heading font-semibold text-slate-900 hover:text-cyan-600 transition-colors"
                >
          ...
          <div className="mt-10 grid grid-cols-2 gap-3">
            {TRUST_STATS.map((s) => (
              ...
              >
                <p className="font-heading text-xl font-extrabold text-slate-900">{s.k}</p>
                <p className="text-[11px] tracking-wider uppercase text-slate-500 font-semibold mt-1">
                  {s.v}
                </p>
              </div>
            ))}
        ...
        <div className="lg:col-span-7">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-lg">
            {submitted ? (
              ...
              >
                <span className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-cyan-50 border border-cyan-200 text-cyan-600">
                ...
                <button
                  ...
                  className="mt-8 inline-flex items-center rounded-md bg-cyan-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-cyan-600 transition-colors"
                >
              ...
              >
                <div className="sm:col-span-2">
                  <label htmlFor="name" className="text-xs tracking-wider uppercase font-semibold text-slate-600">
                    Full name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="text-xs tracking-wider uppercase font-semibold text-slate-600">
                    Work email
                  </label>
                  <input
                    id="email"
                ...
                <div>
                  <label htmlFor="phone" className="text-xs tracking-wider uppercase font-semibold text-slate-600">
                    Phone
                  </label>
                  <input
                    id="phone"
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="company" className="text-xs tracking-wider uppercase font-semibold text-slate-600">
                    Company
                  </label>
                  <input
                    id="company"
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="message" className="text-xs tracking-wider uppercase font-semibold text-slate-600">
                    How can we help?
                  </label>
                  <textarea
                    id="message"
                ...
                <div className="sm:col-span-2 flex items-center justify-between gap-4 pt-2 flex-wrap">
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="inline-flex items-center gap-2 rounded-md bg-cyan-500 px-6 py-3 text-sm font-bold text-white hover:bg-cyan-600 transition-colors shadow-[0_0_25px_rgba(6,182,212,0.35)] disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {submitting ? "Sending..." : (
                      <>
